...
$lang = array_merge($lang, array(
    ...
    "PASS_EMAIL_ONLY"    => "Пожалуйста, проверьте вашу электронную почту для получения ссылки для входа.",
    "PASS_CODE_ONLY"     => "Пожалуйста, введите код, отправленный на вашу электронную почту.",
    "PASS_BOTH"          => "Пожалуйста, проверьте вашу электронную почту для получения ссылки или введите код, отправленный на вашу электронную почту.",
    "PASS_VER_BUTTON"    => "Проверить код",
    "PASS_EMAIL_ONLY_MSG" => "Пожалуйста, подтвердите ваш адрес электронной почты, нажав на ссылку ниже.",
    "PASS_CODE_ONLY_MSG"  => "Пожалуйста, введите код ниже для входа.",
    "PASS_BOTH_MSG"       => "Пожалуйста, подтвердите ваш адрес электронной почты, нажав на ссылку ниже, или введите код ниже для входа.",
    "PASS_YOUR_CODE"      => "Ваш код подтверждения: ",
    "PASS_CONFIRM_LOGIN"  => "Подтвердить вход",
    "PASS_CONFIRM_CLICK"  => "Нажмите для завершения входа",
...
$lang = array_merge($lang, array(
	...
	"2FA_NP"		=> "Сбой логина:  Отсутствует двухфакторный код автонастройки. Пожалуйста, попробуйте еще раз.",
	"2FA_INV"		=> "Сбой логина:  Двухфакторный код был недействителен. Пожалуйста, попробуйте еще раз.",
	"2FA_FATAL"		=> "Фатальная ошибка:  Пожалуйста, свяжитесь с системным администратором",
));
