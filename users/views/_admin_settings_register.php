        ...
        <div class="card mt-2">
          <div class="card-body">
            ...
            if (isset($pw_settings->meter_active)) { ?>
              ...
              <div class="form-group">
                <label for="meter_active">Show Password Meter?</label>
                <span class="float-end offset-switch">
                  <label class="switch switch-text switch-success">
                    <div class="form-check form-switch">
              ...
              <div class="form-group">
                <label for="enforce_rules">Enforce Password Rules?</label>
                <span class="float-end offset-switch">
                  <label class="switch switch-text switch-success">
                    <div class="form-check form-switch">
              ...
              <div class="form-group">
                <label for="req_num">Require a Number in the Password?</label>
                <span class="float-end offset-switch">
                  <label class="switch switch-text switch-success">
                    <div class="form-check form-switch">
              ...
              <div class="form-group">
                <label for="req_cap">Require a Capital Letter in the Password?</label>
                <span class="float-end offset-switch">
                  <label class="switch switch-text switch-success">
                    <div class="form-check form-switch">
              ...
              <div class="form-group">
                <label for="req_low">Require a Lowercase Letter in the Password?</label>
                <span class="float-end offset-switch">
                  <label class="switch switch-text switch-success">
                    <div class="form-check form-switch">
              ...
              <div class="form-group">
                <label for="req_sym">Require a Symbol in the Password?</label>
                <span class="float-end offset-switch">
                  <label class="switch switch-text switch-success">
                    <div class="form-check form-switch">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <label for="">Sample password score tester</label></label><br>
