...
if(!empty($_GET['Modifier'])){
    ...
    if (empty($cin_pass)) {
        ...
        $query = $db->query("SELECT id FROM users WHERE cin_pass = ? and permissions <> ? or cin_pass = ? and permissions <> ?",[$cin_pass, 6, $cin_pass, 1, $cin_pass, 2]);
        $count = $query->count();
        if($count >= 1){
    ...
    <div class="col-sm-12">
        ...
        <p align="center">
            <form action="" method="get">
                ...
                <input class="form-control" type="text" name="cin_pass" value="<?= $cin_pass ?>" placeholder="CIN/Passeport">

                <label for="email">Email</label>
                <input class="form-control" type="text" name="email" value="<?= $email ?>" placeholder="Email">

                <label for="lname">Nom</label>
                <input class="form-control" type="text" name="lname" value="<?= $lname ?>" placeholder="Nom">

                <label for="fname">Prénom</label>
                <input class="form-control" type="text" name="fname" value="<?= $fname ?>" placeholder="Prénom">

                <label for="raison_sociale">Raison Sociale</label>
                <input class="form-control" type="text" name="raison_sociale" value="<?= $raison_sociale ?>" placeholder="Raison Sociale">

                <label for="ice">ICE</label>
                <input class="form-control" type="text" name="ice" value="<?= $ice ?>" placeholder="ICE">

                <label for="tel">Téléphone</label>
                <input class="form-control" type="text" name="tel" value="<?= $tel ?>" placeholder="Téléphone">

                <label for="magasin">Magasin</label>
                <input class="form-control" type="text" name="magasin" value="<?= $magasin ?>" placeholder="Magasin">
